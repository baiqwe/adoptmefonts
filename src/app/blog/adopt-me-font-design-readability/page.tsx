      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="mt-6">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="my-6">
              <img src="/adopt-me-styled-font-name.webp" alt="Roblox Adopt Me gameplay showing styled Unicode font name displayed correctly in-game" className="rounded-lg shadow-lg w-full" loading="lazy" />
              <p className="text-sm text-zinc-500 mt-2 text-center italic">Example of a properly styled font name that displays correctly on all devices</p>
            </div>
