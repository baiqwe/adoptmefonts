      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8">
          ...
          <div className="bg-zinc-50 rounded-lg p-6">
            ...
            <p className="text-zinc-700 mb-4">
              If you&apos;re looking for similar cute styles, check out our <Link href="/" className="text-pink-600 underline">main font generator</Link> to explore cute brackets, heart sparkle, and other adorable styles. They offer similar adorable vibes with different decorative elements. For even more options, explore our <Link href="/symbols" className="text-pink-600 underline">symbol picker</Link> to find the perfect combination.
            </p>
